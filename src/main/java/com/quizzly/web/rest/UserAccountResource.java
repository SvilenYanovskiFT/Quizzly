...
/**
 * REST controller for managing {@link com.quizzly.domain.UserAccount}.
 */
@RestController
@RequestMapping("/api")
public class UserAccountResource {
    ...
    public ResponseEntity<UserAccountDTO> partialUpdateUserAccount(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, userAccountDTO.getId().toString())
        );
    }
