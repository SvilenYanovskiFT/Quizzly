...
/**
 * REST controller for managing {@link com.quizzly.domain.QuestionAnswer}.
 */
@RestController
@RequestMapping("/api")
public class QuestionAnswerResource {
    ...
    public ResponseEntity<QuestionAnswerDTO> updateQuestionAnswer(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, questionAnswerDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/question-answers/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<QuestionAnswerDTO> partialUpdateQuestionAnswer(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, questionAnswerDTO.getId().toString())
        );
    }
