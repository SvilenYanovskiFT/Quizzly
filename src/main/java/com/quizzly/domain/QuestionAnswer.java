...
public class QuestionAnswer implements Serializable {
    ...
    public QuizRezult getRezult() {
        return this.rezult;
    }

    public QuestionAnswer rezult(QuizRezult quizRezult) {
        this.setRezult(quizRezult);
        return this;
    }

    public void setRezult(QuizRezult quizRezult) {
        this.rezult = quizRezult;
    }
